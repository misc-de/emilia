...
install: build mo install-mo
	...
	install -Dm644 data/icons/hicolor/scalable/actions/emilia-longpress-symbolic.svg $(ICON_ACT)/emilia-longpress-symbolic.svg
	install -Dm644 data/icons/hicolor/scalable/actions/podcast-symbolic.svg $(ICON_ACT)/podcast-symbolic.svg
...
# committest sie) und taggt den Stand. Der Commit läuft mit --no-verify, damit
# der version-bump-Hook die gesetzte Version NICHT wieder hochzählt (sonst
# driftet Cargo.toml weg).
