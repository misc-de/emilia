...
impl App {
    ...
    pub(crate) fn open_search_dialog(&self, root: &adw::ApplicationWindow, sender: &ComponentSender<Self>) {
    ...
    pub(crate) fn open_settings(&self, root: &adw::ApplicationWindow, sender: &ComponentSender<Self>) {
        ...
        *self.settings_src_list.borrow_mut() = Some(src_list.clone());
        ...
        let lang_labels = [
            ...
            "Deutsch".into(), "English".into(), "Español".into(), "Français".into(),
            "Italiano".into(), "Kiswahili".into(), "Nederlands".into(), "Polski".into(),
            "Português".into(), "Русский".into(), "العربية".into(), "中文".into(),
        ];
